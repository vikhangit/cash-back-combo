      ...
      >
        {loading && combo ? (
          ...
          <DialogBody className="relaive w-full" id="print">
            ...
            />
            <div className="absolute top-0 2xl:top-8 xl:top-12 lg:top-10 md:top-10 sm:top-8 left-1/2 translate-y-16 sm:translate-y-1/2  -translate-x-1/2 w-5/6 sm:w-2/3 md:w-2/3 lg:w-1/2">
